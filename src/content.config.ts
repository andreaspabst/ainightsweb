...
const speaker = defineCollection({
  ...
  schema: z.object({
    ...
    // Joinify-Freiticket-Gutscheine pro Event (gepflegt vom Skill free-ticket-vouchers)
    voucherCodes: z.array(z.object({ eventSlug: z.string(), code: z.string() })).optional(),
    seo,
